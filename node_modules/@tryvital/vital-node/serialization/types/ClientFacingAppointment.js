...
exports.ClientFacingAppointment = void 0;
const core = __importStar(require("../../core"));
exports.ClientFacingAppointment = core.serialization.object({
    ...
    eventStatus: core.serialization.property("event_status", core.serialization.lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).AppointmentEventStatus; }))),
    eventData: core.serialization.property("event_data", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optional()),
    events: core.serialization.list(core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).ClientFacingAppointmentEvent; }))),
});
