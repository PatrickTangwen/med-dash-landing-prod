...
exports.CreateOrderRequestCompatible = void 0;
...
exports.CreateOrderRequestCompatible = core.serialization.object({
    ...
    physician: core.serialization
        .lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../../..")))).PhysicianCreateRequest; }))
        .optional(),
